...
<html>
          ...
          <div class="col-md-6">
            <div class="box box-info">
              <div class="box-header">
                <h3 class="box-title">Configure Page Details Screen</h3>
              </div>
              <div class="box-body">
  ...
  <script>
    $(document).ready(function(){
      ...
      $.getJSON("https://wp-react.firebaseio.com/"+appname+"/PageDetails/"+menuname+".json", function(result){
        var obj = result;
  ...
  <script src="../controller/pagedetails.js"></script>
</html>
