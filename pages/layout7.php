          ...
          <div class="col-md-6">
            <div class="box box-info">
              ...
              <div class="box-body">
                ...
                <div class="form-group">
                  <label for="sel1">Calendar Day Font Family IOS:</label>
                  <select class="form-control" id="Post_calDayFontIOS">
                    <option>San Francisco</option>
                    <option>Academy Engraved LET</option>
                    <option>AcademyEngravedLetPlain</option>
                    <option>Al Nile</option>
                ...
                <div class="form-group">
                  <label for="sel1">Calendar Month Font Family IOS:</label>
                  <select class="form-control" id="Post_calMonthFontIOS">
                    <option>San Francisco</option>
                    <option>Academy Engraved LET</option>
                    <option>AcademyEngravedLetPlain</option>
                    <option>Al Nile</option>
  ...
  $(document).ready(function(){
    ...
    $.getJSON("https://wp-react.firebaseio.com/"+appname+"/Layout7/"+menuitem+".json", function(result){
      ...
      if(obj.PostArchiveTitleColor!==undefined){
          ...
          document.getElementById("Post_calDayFontIOS").value=obj.CalendarDayFontIOS;
          document.getElementById("Post_calMonthFontIOS").value=obj.CalendarMonthFontIOS;
