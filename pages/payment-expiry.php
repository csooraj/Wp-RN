        ...
        <div class="row">
          <div class="col-md-6">
            <div class="box box-info">
              ...
              <div class="box-header">
                <h3 class="box-title">Test - paymentorder.expired - Notifications</h3>
              </div>
              <div class="box-body">
                <div class="form-group">
                  <label>event</label>
                  <select class="form-control" id="event" disabled>
                    <option selected="selected">paymentorder.expired</option>
                  </select>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" id="next_status" disabled>
...
<script src="../controller/expiry.js"></script>
</html>
